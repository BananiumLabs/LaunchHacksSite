...
$(document).ready(function () {
    ...
    if (document.getElementById("food") !== null && document.getElementById("food") !== undefined) {
        $('#food').load("resources/food.html");
    }

    if (document.getElementById("teamselect") !== null && document.getElementById("teamselect") !== undefined) {
        $('#teamselect').load("resources/teamselect.html");
    }

    if (document.getElementById("resources") !== null && document.getElementById("resources") !== undefined) {
    ...
    if (document.getElementById("rss") !== null && document.getElementById("rss") !== undefined) {
        $('#rss').load("resources/rss.html");
    }
